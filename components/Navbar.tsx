        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <motion.a
              ...
              className="px-6 py-2.5 bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-full transition-all text-sm"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Hire Me
      ...
      {isOpen && (
        ...
        >
          <div className="px-4 py-4 space-y-3">
            ...
            <a
              href="mailto:abdmananch16@gmail.com?subject=Job Opportunity&body=Hi Abdul Mannan, I would like to discuss a job opportunity with you."
              className="block px-6 py-2.5 bg-violet-600 text-white font-semibold rounded-full text-center"
              onClick={() => setIsOpen(false)}
            >
              Hire Me
            </a>
